  ...
  const Item:FC<PaymentProps> = (props) => {
    ...
    return (
      <View style={styles.item}>
        ...
        <TouchableOpacity style={styles.remove} onPress={()=>remove(props.idpayment,props.description)}>
    ...
    <View style={styles.registercontainer}>
      <View style={styles.box}>
        ...
        <View style={styles.boxButton}>
          <TouchableOpacity style={styles.button} onPress={()=>props.add(description.trim(),parseFloat(value))}>
